$(window).on('load', function() {
    $('body').addClass('overflowLoading')

    setTimeout(() => {
        $('#loadingAwal').hide();
        $('body').removeClass('overflowLoading')
        if (typeof (Storage) !== undefined) {
            ...
            alert('Silahkan update browser anda')
        }
                   ...
                   <div class="row d-flex justify-content-center align-items-center conWrap">
                       <form class="col-5 p-5 mt-5 position-relative ">
                         ...
                         <div class="mb-5 mt-3 position-relative emailLogin">
                           <input type="text" class="form-control loginEmail" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" required placeholder="test">
...
function darkMode() {
    if ($('body').hasClass('bodyDark')) {
        ...
        $('.swiper-pagination-bullet').removeClass('swiper-pagination-bullet-Dark');
        ...
        $('path').attr('fill', 'rgba(255,255,255,1)')
        ...
        $('.swiper-pagination-bullet').addClass('swiper-pagination-bullet-Dark');
        $('.navScroll').addClass('navScrollDark');
