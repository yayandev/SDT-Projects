...
if (isset($_POST['gantiPassword'])) {
   if ($_POST['password'] == $_POST['passwordBaru']) {
    ...
    <div class='container' style='position:fixed; z-index:999999; top:0;' id='alert'>
    <div class='alert alert-primary d-flex justify-content-around' role='alert'>
        <p>Change password not success!</p>
        <button type='button' onclick='closeAlert();' class='btn-close'  aria-label='Close'></button>
    </div>
    </div>
    ";
    ...
    <div class='container' style='position:fixed; z-index:999999; top:0;' id='alert'>
    <div class='alert alert-primary d-flex justify-content-around' role='alert'>
        <p>Confirm password is not the same as password !</p>
        <button type='button' onclick='closeAlert();' class='btn-close'  aria-label='Close'></button>
    </div>
    </div>
    ";
         ...
         <div class="modal-body">
            ...
            <form action="" method="post">
               ...
               <div class="mb-3">
                  ...
                  <input type="text" id="password" name="password" class="form-control mb-2" autocomplete="off" required>
               </div>
               <div class="mb-3">
                  <label for="Kategori" class="form-label text-danger">Confirm password!</label>
                  <input type="text" id="passwordBaru" name="passwordBaru" class="form-control mb-2" autocomplete="off" required>
               </div>
            </div>
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
               <button type="submit" name="gantiPassword" class="btn btn-primary">Save</button>
            </div>
         </form>
      </div>
   </div>
